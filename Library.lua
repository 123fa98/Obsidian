...
do
    ...
    function Funcs:AddLabel(...)
        ...
        local TextLabel = New("TextLabel", {
            ...
            Text = Library.Translate(Label.Text),
            TextSize = Data.Size,
    ...
    function Funcs:AddButton(...)
        ...
        local function CreateButton(Button)
            local Base = New("TextButton", {
                ...
                Size = UDim2.fromScale(1, 1),
                Text = Library.Translate(Button.Text),
                TextSize = 14,
        ...
        local function InitEvents(Button)
            ...
            Button.Base.MouseButton1Click:Connect(function()
                ...
                if Button.DoubleClick then
                    ...
                    Button.Base.Text = Library.Translate("Are you sure?")
                    Button.Base.TextColor3 = Library.Scheme.AccentColor
                    Library.Registry[Button.Base].TextColor3 = "AccentColor"

                    local Clicked = WaitForEvent(Button.Base.MouseButton1Click, 0.5)

                    Button.Base.Text = Library.Translate(Button.Text)
        ...
        function Button:AddButton(...)
            ...
            function SubButton:SetText(Text: string)
                SubButton.Text = Text
                SubButton.Base.Text = Library.Translate(Text)
            end
        ...
        function Button:SetText(Text: string)
            Button.Text = Text
            Button.Base.Text = Library.Translate(Text)
        end
    ...
    function Funcs:AddCheckbox(Idx, Info)
        ...
        local Label = New("TextLabel", {
            ...
            Text = Library.Translate(Toggle.Text),
            TextSize = 14,
            TextTransparency = 0.4,
            TextXAlignment = Enum.TextXAlignment.Left,
            Parent = Button,
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        function Toggle:SetText(Text: string)
            Toggle.Text = Text
            Label.Text = Library.Translate(Text)
        end
    ...
    function Funcs:AddInput(Idx, Info)
        ...
        local Label = New("TextLabel", {
            ...
            Text = Library.Translate(Input.Text),
            TextSize = 14,
            TextXAlignment = Enum.TextXAlignment.Left,
            Parent = Holder,
        })
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        if not Info.Compact then
            SliderLabel = New("TextLabel", {
                BackgroundTransparency = 1,
                Size = UDim2.new(1, 0, 0, 14),
                Text = Library.Translate(Slider.Text),
                TextSize = 14,
                TextXAlignment = Enum.TextXAlignment.Left,
                Parent = Holder,
            })
        ...
        function Slider:Display()
            ...
            if CustomDisplayText then
                ...
                if Info.Compact then
                    DisplayLabel.Text =
                        string.format("%s: %s%s%s", Library.Translate(Slider.Text), Slider.Prefix, Slider.Value, Slider.Suffix)
        ...
        function Slider:SetText(Text: string)
            Slider.Text = Text
            if SliderLabel then
                SliderLabel.Text = Library.Translate(Text)
                return
            end
            Slider:Display()
        end
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        local Label = New("TextLabel", {
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 0, 14),
            Text = Library.Translate(Dropdown.Text),
            TextSize = 14,
            TextXAlignment = Enum.TextXAlignment.Left,
        ...
        function Dropdown:SetText(Text: string)
            ...
            Label.Text = Text and Library.Translate(Text) or ""
